 ...
 * Shows cube data
 */
class ApiCubeInfo extends ApiAbstractRequest
{
    /**
    ...
    /**
     * If 1 return also the list of identifiers of virtual attribute dimensions'
     * source dimensions (optional, default is 0)
     *
     * Jedox-Doc type: boolean
     */
